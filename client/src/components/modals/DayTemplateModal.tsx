...
export function DayTemplateModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[450px] p-0 bg-[#1E2429] border-white/10 overflow-hidden" hideCloseButton>
        {/* Header */}
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="p-6 pt-2 space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-[#181818] rounded-xl border border-white/5 p-3">
                <Calendar
                  mode="single"
            ...
            {mode !== 'apply' && (
              <FormField
                ...
                name="isTemplate"
                render={({ field }) => (
                  <FormItem className="flex flex-row items-start space-x-3 space-y-0 rounded-xl border border-white/10 bg-[#181818] p-4">
                    <FormControl>
                      <Checkbox
                        checked={field.value}
