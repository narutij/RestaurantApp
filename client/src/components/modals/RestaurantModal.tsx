          ...
          {isLoading ? (
            ...
            <div className="p-6 pt-2 space-y-4">
              ...
              <div className="flex justify-center">
                ...
                <button
                  ...
                  className="relative w-20 h-20 border-2 border-dashed border-gray-300 dark:border-white/20 rounded-full hover:border-white/40 transition-colors group overflow-hidden"
                >
                  {imagePreview ? (
                    <>
            ...
            <ScrollArea className="max-h-[calc(85vh-120px)]">
              <div className="p-6 pt-2 space-y-4">
                ...
                <Button
                  variant="outline"
                  className="w-full border-dashed border-gray-300 dark:border-white/20 hover:border-white/40 hover:bg-white/5"
                  onClick={() => {
                    resetForm();
                    setCreateMode(true);
                  }}
